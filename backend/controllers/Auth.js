...
exports.forgotPassword=async(req,res)=>{
    ...
    try {
        ...
        We received a request to reset the password for your Ecommerce account. If you initiated this request, please use the following link to reset your password:</p>
